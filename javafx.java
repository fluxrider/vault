...
public class javafx extends Application { public static void main(String[] args) { launch(args); }
  ...
  @Override public void start(Stage stage) { try {
    FXMLLoader loader = new FXMLLoader(new File("javafx.fxml").toURI().toURL()); Parent root = loader.load(); javafx_controller controller = loader.<javafx_controller>getController(); controller.window = stage;
